...
const TweetList = ({ tweet, followers = false}) => {
    return (
        <div className="bg-black/90 rounded-[10px] max-w-full text-textColorActive p-2 md:p-4 hover:bg-black/40">
            <h5 className="font-light mb-3">Recent Tweets By <span className='font-bold'>{tweet}</span></h5>
            <div className='flex flex-col md:flex-row gap-2 md:max-w-full overflow-x-auto'>
...
const RightSocialMedia = () => {
  return (
    ...
    className="rounded-[10px] bg-[#A4A4A4] flex-1 p-2 md:p-4 flex flex-col gap-4 overflow-y-auto">
